...
<div class="gle__nav">
  ...
  <nav class="gle__navlinks">
    ...
    <a href="{{ '/cv/'       | relative_url }}" class="is-active">CV</a>
  </nav>
</div>
...
<div class="gle">
  ...
  <div class="gle__row">
    <div class="gle__rowlabel">Download</div>
    <div class="gle__rowbody">
      <a class="gle__btn" href="{{ '/files/cv.pdf' | relative_url }}">Download full CV (PDF) &darr;</a>
    </div>
  </div>
    ...
    <div class="gle__rowbody">
      ...
      <div style="display:grid;grid-template-columns:90px 1fr;gap:20px;align-items:baseline;margin-bottom:24px;">
        ...
        <div>
          ...
          <div style="font-family:'Public Sans',sans-serif;font-size:13px;color:#6a7078;margin-top:3px;font-style:italic;">University Paris 1 Panthéon-Sorbonne</div>
        </div>
      </div>
...
<div class="gle__row">
    <div class="gle__rowlabel">Grants &amp; fellowships</div>
    <div class="gle__rowbody">

      <div style="display:grid;grid-template-columns:90px 1fr;gap:20px;align-items:baseline;">
        <div style="font-family:'Space Mono',monospace;font-size:13px;color:#c8921a;font-weight:700;">2024-2027</div>
        <div>
  ...
  <div class="gle__row">
    <div class="gle__rowlabel">Awards &amp; distinctions</div>
    <div class="gle__rowbody">
